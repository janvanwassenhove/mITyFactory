...
graph TB
    ...
    subgraph "Logical View"
        LV[Domain Model<br/>Classes & Modules]
    end
    
    subgraph "Development View"
        DV[Components<br/>Packages & Layers]
    end
    
    subgraph "Process View"
        PV[Runtime Behavior<br/>Async/Concurrency]
    end
...
| [Process](process.md) | Runtime behavior, async patterns | Integrators, Developers |
